...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("http://www.example.com/support")
            .version("1.0.0")
            .contact(new Contact("","", "julian.brown@engineering.digital.dwp.gov.uk"))
            .build();
    }
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
            .info(new Info()
                .title("Example Task Board API")
                .description("This is a contract first api example for demonstration")
                .termsOfService("http://www.example.com/support")
                .version("1.0.0")
                .license(new License()
                    .name("Apache 2.0")
